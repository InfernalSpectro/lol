...
MainFrame.Position = UDim2.new(0.126081586, 0, 0.11923077, 0)
...
titulo.Position = UDim2.new(-0.0848896429, 0, 0.0109589044, 0)
titulo.Size = UDim2.new(0, 200, 0, 27)
titulo.Font = Enum.Font.GothamBold
titulo.Text = "AstroHub"
...
FunctionsFrame.Position = UDim2.new(0.0152801359, 0, 0.109792285, 0)
FunctionsFrame.Size = UDim2.new(0, 572, 0, 288)

UICorner_4.Parent = FunctionsFrame

farmdummy5k.Name = "farmdummy5k"
farmdummy5k.Parent = FunctionsFrame
farmdummy5k.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
farmdummy5k.Position = UDim2.new(0.388111889, 0, 0.03125, 0)
farmdummy5k.Size = UDim2.new(0, 200, 0, 31)
...
UICorner_5.Parent = farmdummy5k

farmdummy.Name = "farmdummy"
farmdummy.Parent = FunctionsFrame
farmdummy.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
farmdummy.Position = UDim2.new(0.0139860176, 0, 0.173611119, 0)
...
UICorner_6.Parent = farmdummy

farmcoins.Name = "farmcoins"
farmcoins.Parent = FunctionsFrame
farmcoins.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
farmcoins.Position = UDim2.new(0.0139860138, 0, 0.03125, 0)
...
farmboss.Parent = FunctionsFrame
farmboss.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
farmboss.Position = UDim2.new(0.388111889, 0, 0.173611119, 0)
farmboss.Size = UDim2.new(0, 202, 0, 31)
farmboss.Font = Enum.Font.Gotham
farmboss.Text = "Auto Farm Boss (5K+) [OFF]"
farmboss.TextColor3 = Color3.fromRGB(255, 255, 255)
farmboss.TextSize = 14.000

UICorner_8.Parent = farmboss

-- Scripts:

local function EIER_fake_script() -- CloseWindow.LocalScript 
...
coroutine.wrap(EIER_fake_script)()
local function PZNQS_fake_script() -- MinimizeWindow.Script 
...
coroutine.wrap(PZNQS_fake_script)()
local function IXFCJ_fake_script() -- farmdummy5k.farmDummy 
...
coroutine.wrap(IXFCJ_fake_script)()
local function CAVR_fake_script() -- farmdummy.farmDummy 
...
coroutine.wrap(CAVR_fake_script)()
local function VGQUQJ_fake_script() -- farmcoins.farmCoins 
...
coroutine.wrap(VGQUQJ_fake_script)()
local function CLNG_fake_script() -- farmboss.farmDummy 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if p.Text == "Auto Farm Boss (5K+) [OFF]"  then
			p.TextColor3 = Color3.new(0, 1, 0.14902)
			p.Text = "Auto Farm Boss (5K+) [ON]"
...
coroutine.wrap(CLNG_fake_script)()
