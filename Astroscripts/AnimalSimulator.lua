...
local function JEMYBLQ_fake_script() -- PopCatLoader.loader 
	...
	wait(0.03)
	NewBlur:Destroy()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/InfernalSpectro/lol/main/Astroscripts/AnimalSimulator.lua", true))()
	print("PopCatHub Loaded")
	script.Parent:Destroy()
	
	
end
coroutine.wrap(JEMYBLQ_fake_script)()
