...
AstroHub.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
...
UICorner_3.Parent = MinimizeWindow
...
UICorner_4.Parent = FunctionsFrame
...
UICorner_5.Parent = freeFireball
...
UICorner_10.Parent = antiafkHatredBR
...
UICorner_13.Parent = tituloImagem
...
UICorner_14.Parent = barraLateral
...
UICorner_16.Parent = DarkBack

-- Scripts:

local function VQDNJQ_fake_script() -- titulo.RainbowText 
...
coroutine.wrap(VQDNJQ_fake_script)()
local function ZEQLTML_fake_script() -- CloseWindow.LocalScript 
...
coroutine.wrap(ZEQLTML_fake_script)()
local function RVXLSRU_fake_script() -- CloseWindow.UIButtonEffectScript 
	local script = Instance.new('LocalScript', CloseWindow)
...
coroutine.wrap(RVXLSRU_fake_script)()
local function RINNKH_fake_script() -- MinimizeWindow.Script 
...
coroutine.wrap(RINNKH_fake_script)()
local function ZCKMOI_fake_script() -- MinimizeWindow.UIButtonEffectScript 
...
coroutine.wrap(ZCKMOI_fake_script)()
local function LMAF_fake_script() -- freeFireball.UIButtonEffectScript 
...
coroutine.wrap(LMAF_fake_script)()
local function MXTCJNO_fake_script() -- farmboss.farmDummy 
...
coroutine.wrap(MXTCJNO_fake_script)()
local function UDIH_fake_script() -- farmboss.UIButtonEffectScript 
...
coroutine.wrap(UDIH_fake_script)()
local function FNMAWM_fake_script() -- farmcoins.farmCoins 
...
coroutine.wrap(FNMAWM_fake_script)()
local function HHQP_fake_script() -- farmcoins.UIButtonEffectScript 
...
coroutine.wrap(HHQP_fake_script)()
local function BHQR_fake_script() -- farmdummy.farmDummy 
...
coroutine.wrap(BHQR_fake_script)()
local function KKVLMOA_fake_script() -- farmdummy.UIButtonEffectScript 
...
coroutine.wrap(KKVLMOA_fake_script)()
local function TCIDUS_fake_script() -- farmdummy5k.farmDummy 
...
coroutine.wrap(TCIDUS_fake_script)()
local function QJLM_fake_script() -- farmdummy5k.UIButtonEffectScript 
...
coroutine.wrap(QJLM_fake_script)()
local function ZWAC_fake_script() -- antiafkHatredBR.farmDummy 
...
coroutine.wrap(ZWAC_fake_script)()
local function WDZNKB_fake_script() -- antiafkHatredBR.UIButtonEffectScript 
...
coroutine.wrap(WDZNKB_fake_script)()
local function BXQWRLV_fake_script() -- ScrollingMain.Script 
...
coroutine.wrap(BXQWRLV_fake_script)()
local function CGDVB_fake_script() -- ativar.farmDummy 
...
coroutine.wrap(CGDVB_fake_script)()
local function HOZFRA_fake_script() -- ativar.UIButtonEffectScript 
...
coroutine.wrap(HOZFRA_fake_script)()
local function BHUEYZS_fake_script() -- main.UIButtonEffectScript 
...
coroutine.wrap(BHUEYZS_fake_script)()
local function SYDPZN_fake_script() -- main.Script 
...
coroutine.wrap(SYDPZN_fake_script)()
local function GAWIXW_fake_script() -- functions.UIButtonEffectScript 
...
coroutine.wrap(GAWIXW_fake_script)()
local function YMAXCQE_fake_script() -- functions.Script 
...
coroutine.wrap(YMAXCQE_fake_script)()
local function VLYS_fake_script() -- creditos.RainbowText 
...
coroutine.wrap(VLYS_fake_script)()
local function GBPB_fake_script() -- versao.RainbowText 
...
coroutine.wrap(GBPB_fake_script)()
local function TJEMSI_fake_script() -- scripts.RainbowText 
...
coroutine.wrap(TJEMSI_fake_script)()
local function MAUQMG_fake_script() -- creditos_2.RainbowText 
...
coroutine.wrap(MAUQMG_fake_script)()
